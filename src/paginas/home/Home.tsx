...
function Home() {
  return (
    <>
      <Grid container direction="row" justifyContent="center" alignItems="center" className="container" style={{ backgroundColor: "#3F51B5" }}>
                <Grid alignItems="center" item xs={6}>
                    ...
                    <Box display="flex" justifyContent="center">
                        ...
                        <Button variant="outlined" className="btn" style={{ borderColor: "white", backgroundColor: "#3F51B5", color: "white" }}>Ver Postagens</Button>
                    </Box>
                </Grid>
                <Grid item xs={6} >
                    <img src="https://pbs.twimg.com/media/FbBPK--WAAARYvn?format=png&name=small" alt="" width="500px" height="512px" />
                </Grid>
