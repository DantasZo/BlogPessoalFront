    ...
    return (
        <Grid container direction='row' justifyContent='center' alignItems='center' >
            <Grid alignItems='center' xs={6}>
                <Box paddingX={20}>
                    ...
                    <Box display='flex' justifyContent='center' marginTop={2}>
                        <Box marginRight={1}>
                            <Typography variant='subtitle1' gutterBottom align='center' className='color-weight'>Não tem uma conta?</Typography>
                        </Box>
            ...
            <Grid xs={6} className='imagem' style={{
                backgroundImage: `url(https://pbs.twimg.com/media/FbBPK--WAAARYvn?format=png&name=small)`,
